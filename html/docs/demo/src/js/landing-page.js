(function($) {
  ...
  var LandingPage = {
    ...
    scrollAnimationHandler: function(direction) {
      var $element = $(this.element),
        cssClasses = ['animated'], match;
      ...
      $element.removeAttr('data-animation-name')
        .removeAttr('data-animation-duration')
        .removeAttr('data-animation-delay')
    ...
    scrollCountUpHandler: function(direction) {
      var $element = $(this.element),
        counter, startVal, endVal;
