angular.module("elephant")
  ...
  .controller("DashboardCtrl", function($scope) {
    ...
    $scope.audienceOverview = {
      ...
      colors: [{
        backgroundColor: "#f7a033",
        borderColor: "#f7a033",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent",
      }, {
        backgroundColor: "#ed4882",
        borderColor: "#ed4882",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent",
      }],
  ...
  .controller("WidgetsCtrl", function($scope) {
    ...
    $scope.pageviews3 = {
      ...
      labels: ["Jun 21", "Jun 20", "Jun 19", "Jun 18", "Jun 17", "Jun 16", "Jun 15"],
      colors: [{
        backgroundColor: "rgba(247,160,51,0.75)",
        borderColor: "rgba(247,160,51,0.75)",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent"
      }, {
        backgroundColor: "rgba(237,72,130,0.75)",
        borderColor: "rgba(237,72,130,0.75)",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent"
      }],
      options: {
