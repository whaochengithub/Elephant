angular.module("elephant")
  ...
  .controller("DashboardCtrl", function($scope) {
    ...
    $scope.audienceOverview = {
      ...
      data: [
        [5022, 11017, 12230, 8801, 14102, 21512, 9932],
        [5012, 7203, 10204, 15052, 14820, 21805, 13203]
      ],
    ...
    $scope.signups = {
      series: ["This week", "Last week"],
      data: [
        [23167, 15991, 13905, 17447, 24558, 22594, 23067],
        [7374, 16740, 22929, 16788, 12103, 16459, 24058]
      ],
      labels: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
      colors: [{
        backgroundColor: "#7c55fb",
    ...
    $scope.resolvedIssues = {
      ...
      colors: [{
        backgroundColor: ["#7c55fb", "#667589"],
        borderColor: ["#1d2a39", "#1d2a39"],
      }],
      options: {
        animation: false,
        responsive: true,
  ...
  .controller("Dashboard3Ctrl", function($scope) {
    ...
    $scope.audienceOverview = {
      series: ["New Visitor", "Returning Visitor"],
      data: [
        [325, 427, 399, 458, 745, 587, 758, 754, 710, 841, 645, 548, 645, 651, 645, 712, 631, 754, 611, 645, 500, 490, 565, 751, 654, 658, 456, 445, 701, 711],
        [750, 772, 871, 1011, 1136, 985, 1003, 897, 945, 975, 957, 1070, 1121, 1065, 1222, 1065, 1235, 1312, 1165, 1135, 1130, 1136, 1009, 1035, 1003, 981, 965, 1098, 958, 1205]
      ],
      labels: ["01 Jun, 2017", "02 Jun, 2017", "03 Jun, 2017", "04 Jun, 2017", "05 Jun, 2017", "06 Jun, 2017", "07 Jun, 2017", "08 Jun, 2017", "09 Jun, 2017", "10 Jun, 2017", "11 Jun, 2017", "12 Jun, 2017", "13 Jun, 2017", "14 Jun, 2017", "15 Jun, 2017", "16 Jun, 2017", "17 Jun, 2017", "18 Jun, 2017", "19 Jun, 2017", "20 Jun, 2017", "21 Jun, 2017", "22 Jun, 2017", "23 Jun, 2017", "24 Jun, 2017", "25 Jun, 2017", "26 Jun, 2017", "27 Jun, 2017", "28 Jun, 2017", "29 Jun, 2017", "30 Jun, 2017"],
      colors: [{
        backgroundColor: "#63d9ad",
        borderColor: "#63d9ad",
        pointBackgroundColor: "transparent",
  ...
  .controller("WidgetsCtrl", function($scope) {
    ...
    $scope.pageviews3 = {
      ...
      data: [
        [5022, 11017, 12230, 8801, 14102, 21512, 9932],
        [19, 5022, 11017, 12230, 8801, 14102, 21512],
      ],
      labels: ["Jun 21", "Jun 20", "Jun 19", "Jun 18", "Jun 17", "Jun 16", "Jun 15"],
      colors: [{
        backgroundColor: "rgba(124,85,251,0.75)",
        borderColor: "rgba(124,85,251,0.75)",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent"
      }, {
        backgroundColor: "rgba(99,217,173,0.75)",
        borderColor: "rgba(99,217,173,0.75)",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent"
      }],
      options: {
    ...
    $scope.newReturning = {
      ...
      colors: [{
        backgroundColor: ["#f98b60", "#ffffff"],
        borderColor: ["#3189fb", "#3189fb"]
      }],
      options: {
        animation: false,
        responsive: true,
