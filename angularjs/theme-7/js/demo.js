angular.module("elephant")
  ...
  .controller("DashboardCtrl", function($scope) {
    $scope.visitors = {
      ...
      colors: [{
        backgroundColor: "rgba(217, 35, 15, 0.03)",
        borderColor: "#d9230f",
    ...
    $scope.audienceOverview = {
      ...
      colors: [{
        ...
        borderColor: "#d9230f",
        pointBackgroundColor: "#d9230f"
      }, {
        backgroundColor: "rgba(0, 0, 0, 0)",
        borderColor: "#d9831f",
        pointBackgroundColor: "#d9831f"
      }],
      options: {
        animation: false,
        responsive: true,
