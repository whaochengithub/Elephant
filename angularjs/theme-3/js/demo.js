angular.module("elephant")
  ...
  .controller("DashboardCtrl", function($scope) {
    ...
    $scope.audienceOverview = {
      ...
      colors: [{
        backgroundColor: "#7e7dcf",
        borderColor: "#7e7dcf",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent",
      }, {
        backgroundColor: "#1db2c6",
        borderColor: "#1db2c6",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent",
      }],
  ...
  .controller("WidgetsCtrl", function($scope) {
    ...
    $scope.pageviews3 = {
      ...
      labels: ["Jun 21", "Jun 20", "Jun 19", "Jun 18", "Jun 17", "Jun 16", "Jun 15"],
      colors: [{
        backgroundColor: "rgba(126,125,207,0.75)",
        borderColor: "rgba(126,125,207,0.75)",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent"
      }, {
        backgroundColor: "rgba(29,178,198,0.75)",
        borderColor: "rgba(29,178,198,0.75)",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent"
      }],
      options: {
