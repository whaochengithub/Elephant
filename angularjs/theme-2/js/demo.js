angular.module("elephant")
  ...
  .controller("DashboardCtrl", function($scope) {
    ...
    $scope.audienceOverview = {
      ...
      colors: [{
        backgroundColor: "#f1595d",
        borderColor: "#f1595d",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent",
      }, {
        backgroundColor: "#13b6bc",
        borderColor: "#13b6bc",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent",
      }],
  ...
  .controller("WidgetsCtrl", function($scope) {
    ...
    $scope.pageviews3 = {
      ...
      labels: ["Jun 21", "Jun 20", "Jun 19", "Jun 18", "Jun 17", "Jun 16", "Jun 15"],
      colors: [{
        backgroundColor: "rgba(241,89,93,0.75)",
        borderColor: "rgba(241,89,93,0.75)",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent"
      }, {
        backgroundColor: "rgba(19,182,188,0.75)",
        borderColor: "rgba(19,182,188,0.75)",
        pointBackgroundColor: "transparent",
        pointBorderColor: "transparent"
      }],
      options: {
